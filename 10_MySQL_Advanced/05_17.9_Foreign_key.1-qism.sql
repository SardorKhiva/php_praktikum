...
/*
Tepada keltirilgan kodda kichik sintaksis xatosi bor.
FOREIGN KEYga nom berishni alohida ko'rsatganingiz uchun,
course_id ustuni ustida bir vaqtning o'zida FOREIGN KEY
e'lon qilinishi kerak emas. Buning o'rniga, CONSTRAINT
orqali alohida e'lon qilinadi.
 */
CREATE TABLE IF NOT EXISTS `student_2`
(
    `id`        INT UNSIGNED NOT NULL AUTO_INCREMENT,
